...
public class UsingTheTryWithResourceBlockToImproveExceptionCodeHandling {
	...
	public static void main(String[] args) {
		try (BufferedReader inputReader = Files.newBufferedReader(Paths.get(new URI("file:///F:/github/java7/java7-new-features/src/main/resources/chapter1/users.txt")),
				Charset.defaultCharset());
				BufferedWriter outputWriter = Files.newBufferedWriter(
						Paths.get(new URI("file:///F:/github/java7/java7-new-features/src/main/resources/chapter1/users.bak")), Charset.defaultCharset())) {
			String inputLine;
		...
		// }
		//
		// try (BufferedReader inputReader = Files.newBufferedReader(path,
		// Charset.defaultCharset())) {
		// String inputLine;
		// while ((inputLine = inputReader.readLine()) != null) {
